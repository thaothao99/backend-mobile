...
const dataLoad = [
  ...
  },
  {
    ...
    categories: ["LifeStyle", "Training-Gym"],
    brand: "Nike",
    date: "2020-01-10"
  },
  {
    ...
    categories: ["Running", "Training-Gym"],
    brand: "Nike",
    date: "2010-01-14"
  },
  {
  ...
  },
  {
    ...
    categories: ["Running", "LifeStyle", "Fashion"],
    brand: "Reebok",
    date: "2019-11-19"
  },
  {
  ...
  },
  {
    ...
    categories: ["Running", "Fashion", "LifeStyle"],
    brand: "Reebok",
    date: "2010-12-04"
  },
  {
  ...
  },
  {
    ...
    categories: ["Running", "Other", "Training-Gym"],
    brand: "Biti's",
    date: "2017-01-24"
  },
  {
    ...
    categories: ["Training-Gym", "Running"],
    brand: "Biti's",
    date: "2017-04-14"
  },
  {
    ...
    categories: [ "Lifestyle", "Running", "Training-Gym"],
    brand: "Vans",
    date: "2015-01-14"
  },
  {
  ...
  },
  {
    ...
    categories: ["Training-Gym", "Other", "Running"],
    brand: "Converse",
    date: "2016-10-24"
  },
  {
    ...
    categories: ["Training-Gym", "Other", "Fashion"],
    brand: "Converse",
    date: "2015-05-14"
  },
  {
  ...
  },
  {
    ...
    categories: ["Fashion", "Other", "Running"],
    brand: "Nike",
    date: "2017-12-16"
  },
  {
  ...
  },
  {
    ...
    categories: ["Fashion", "Other", "Tranning-Gym"],
    brand: "Nike",
    date: "2020-11-26"
  },
  {
...
export class ProductService {
  ...
  async getByBrand(name: string, categories: string, nameProduct: string, sort: string): Promise<Product[]>{
    let search = []
    search.push(categories)
    if(name) {
      const data = await this.productModel.find({brand: name}).exec();
      return data  
    }
    if(categories){
      // console.log(search)
      const data = await this.productModel.find({categories: {$all: search}}).exec();
      return data
  
    }
    if(nameProduct){
      // const conditional = { isActive: true }
      // conditional['name']= { $regex: new RegExp(nameProduct,'gi') }
      if(sort) {
        // console.log('sorted')
        switch(sort) {
          case 'newest':
            return await this.productModel.find({name:{ $regex: nameProduct, $options: 'gi' }}).sort({'date': -1})
          case 'hight-ratting':
            return await this.productModel.find({name:{ $regex: nameProduct, $options: 'gi' }}).sort({'ratingsAverage': -1})
          case 'hight-price':
          return await this.productModel.find({name:{ $regex: nameProduct, $options: 'gi' }}).sort({'price': -1})
          case 'low-price':
            return await this.productModel.find({name:{ $regex: nameProduct, $options: 'gi' }}).sort({'price': 1})
          case 'none':
            return await this.productModel.find({name:  { $regex: nameProduct, $options: 'gi' } })
        }
      }
      else{
        const data = await this.productModel.find({name:  { $regex: nameProduct, $options: 'gi' } })
        // console.log(data)
        return data
